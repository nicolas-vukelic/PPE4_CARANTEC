...
@foreach($liste_avis as $avis)
    <div class="card" style="width: 50rem; margin-left: 35rem; margin-top: 1rem;">
        ...
        <div class="card-body">
            <h5 class="card-title"><b>Avis de  :</b> {{$avis->NOM}} {{$avis->PRENOM}}</h5>
            <p class="card-text">{{$avis->NOTE}}/10</p>
...
@endforeach
    ...
    <a href="/avis" class="card-link" style="margin-left: 35rem;"><b>Publier mon avis</b></a>
